...
class Goodwe extends IPSModule
{
    ...
    private function GetRegisters()
    {
        ...
        ["address" => 35184, "name" => "Bat1 Mode", "type" => "S16", "unit" => "", "scale" => 1],
        ["address" => 47907, "name" => "Bat1 Strom", "type" => "S16", "unit" => "A", "scale" => 0.1],
        ["address" => 47903, "name" => "Bat1 Laden Strom max", "type" => "S16", "unit" => "A", "scale" => 0.1],
        ["address" => 47905, "name" => "Bat1 Entladen Strom max", "type" => "S16", "unit" => "A", "scale" => 0.1],
        ["address" => 47906, "name" => "Bat1 Spannung", "type" => "S16", "unit" => "V", "scale" => 0.1],
        ["address" => 35182, "name" => "Bat1 Leistung", "type" => "S32", "unit" => "W", "scale" => 1],
        ["address" => 47909, "name" => "Bat1 SOH", "type" => "S16", "unit" => "%", "scale" => 1],
        ["address" => 37003, "name" => "BMS Pack Temperature", "type" => "S16", "unit" => "°C", "scale" => 0.1],
        ["address" => 35206, "name" => "E-BatteryCharge", "type" => "S32", "unit" => "kWh", "scale" => 0.1],
        ...
        ["address" => 35189, "name" => "Error Message", "type" => "U32", "unit" => "", "scale" => 1],
        ["address" => 35104, "name" => "Strom String Ost", "type" => "S16", "unit" => "A", "scale" => 0.1],
        ["address" => 35107, "name" => "Spannung String Ost", "type" => "S16", "unit" => "V", "scale" => 0.1],
        ["address" => 35108, "name" => "Strom String West", "type" => "S16", "unit" => "A", "scale" => 0.1],
        ["address" => 35103, "name" => "Spannung String West", "type" => "S16", "unit" => "V", "scale" => 0.1],
        ["address" => 35345, "name" => "I MPPT1", "type" => "S16", "unit" => "A", "scale" => 0.1],
        ["address" => 35346, "name" => "I MPPT2", "type" => "S16", "unit" => "A", "scale" => 0.1],
        ["address" => 35347, "name" => "I MPPT3", "type" => "S16", "unit" => "A", "scale" => 0.1],
        ["address" => 35337, "name" => "P MPPT1", "type" => "S16", "unit" => "W", "scale" => 1],
        ["address" => 35338, "name" => "P MPPT2", "type" => "S16", "unit" => "W", "scale" => 1],
        ["address" => 35339, "name" => "P MPPT3", "type" => "S16", "unit" => "W", "scale" => 1]
        ];
    }
}
