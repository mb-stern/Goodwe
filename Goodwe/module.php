...
class Goodwe extends IPSModule
{
    public function Create()
    {
        ...
        $this->RegisterTimer('Timer-WR', 0, 'Goodwe_FetchInverterData($_IPS[\'TARGET\']);');  
        $this->RegisterTimer('Timer-WB', 0, 'Goodwe_FetchWallboxData($_IPS[\'TARGET\']);'); 
    }
    ...
    public function ApplyChanges()
    {
        ...
        $this->SetTimerInterval('Timer-WR', $this->ReadPropertyInteger('PollIntervalWR') * 1000);
        $this->SetTimerInterval('Timer-WB', $this->ReadPropertyInteger('PollIntervalWB') * 1000);
