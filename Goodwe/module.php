...
class Goodwe extends IPSModuleStrict
{
    ...
    private function GetRegisters()
    {
        return [
            ...
            ["address" => 39512, "name" => "BAT - Laden Leistung max",   "type" => "S16", "unit" => "W",  "scale" => 0.1, "pos" => 205],
            ...
            ["address" => 39513, "name" => "BAT - Entaden Leistung max",   "type" => "S16", "unit" => "W",  "scale" => 0.1, "pos" => 225],
