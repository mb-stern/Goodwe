...
class Goodwe extends IPSModuleStrict
{
    ...
    private function GetRegisters()
    {
        return [
            ...
            ["address" => 51007, "name" => "BAT - Laden Leistung max",   "type" => "S16", "unit" => "W",  "scale" => 0.1, "pos" => 205],
            ...
            ["address" => 51002, "name" => "BAT - Entladen Leistung max",   "type" => "S16", "unit" => "W",  "scale" => 0.1, "pos" => 225],
            ...
            ["address" => 35339, "name" => "WR - P MPPT3",            "type" => "S16", "unit" => "W",  "scale" => 1,   "pos" => 670],
            ["address" => 35340, "name" => "WR - P MPPT4",            "type" => "S16", "unit" => "W",  "scale" => 1,   "pos" => 680],
            ["address" => 35341, "name" => "WR - P MPPT5",            "type" => "S16", "unit" => "W",  "scale" => 1,   "pos" => 690],
            ["address" => 35342, "name" => "WR - P MPPT6",            "type" => "S16", "unit" => "W",  "scale" => 1,   "pos" => 700],
            ["address" => 35343, "name" => "WR - P MPPT7",            "type" => "S16", "unit" => "W",  "scale" => 1,   "pos" => 710],
            ["address" => 35344, "name" => "WR - P MPPT8",            "type" => "S16", "unit" => "W",  "scale" => 1,   "pos" => 720],
            ["address" => 35345, "name" => "WR - I MPPT1",            "type" => "S16", "unit" => "A",  "scale" => 0.1, "pos" => 730],
            ["address" => 35346, "name" => "WR - I MPPT2",            "type" => "S16", "unit" => "A",  "scale" => 0.1, "pos" => 740],
            ["address" => 35347, "name" => "WR - I MPPT3",            "type" => "S16", "unit" => "A",  "scale" => 0.1, "pos" => 750],
            ["address" => 35348, "name" => "WR - I MPPT4",            "type" => "S16", "unit" => "A",  "scale" => 0.1, "pos" => 760],
            ["address" => 35349, "name" => "WR - I MPPT5",            "type" => "S16", "unit" => "A",  "scale" => 0.1, "pos" => 770],
